...
// "measure unit"
#define SIZE 32 // size of the squares (Pixels), which defines all objects in the scene basically - BORDER INCLUDED
...
// window size
const int SCREEN_WIDTH = 20 * SIZE;
const int SCREEN_HEIGHT = 14 * SIZE;
...
#define SLOWEST_SPEED 18 // slowest speed of a piece (int)
...
#define FONT_PATH "assets/consola.ttf" // font used in the game